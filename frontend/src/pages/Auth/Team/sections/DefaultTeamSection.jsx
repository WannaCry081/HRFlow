...
const GroupContainer = (prop) => {
  return (
    ...
    >
      <div
        className={`${
          prop.container == 0 || prop.container === prop.activeContainer
            ? ""
            : "grayscale"
        } p-4 flex items-center h-full w-full justify-center flex-col relative`}
      >
        <p className="absolute bottom-2 font-poppins font-semibold text-secondary-light">
          {prop.title}
        </p>
        {prop.children}
      </div>
