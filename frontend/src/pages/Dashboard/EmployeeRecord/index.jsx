    ...
    return (
        <div className="flex h-full">
            {addEmployee
                ...
                : <>
                    <section className="w-[75%] bg-primary-palePastel rounded-t-[2.5rem] p-8 flex flex-col">
                        ...
                        <div className="flex justify-between w-full items-center my-4">
                            ...
                            <div
                                ...
                                className="w-1/5 lg:w-56 gap-2 bg-primary-light flex items-center rounded-lg justify-center hover:bg-primary-dark h-full">
