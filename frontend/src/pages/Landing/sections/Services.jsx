...
import Bell from "/src/assets/svg/icons/Bell.svg";
import Clock from "/src/assets/svg/icons/Clock.svg";
import Coin from "/src/assets/svg/icons/Coin.svg";
import Folder from "/src/assets/svg/icons/Folder.svg";
import Megaphone from "/src/assets/svg/icons/Megaphone.svg";
import Person from "/src/assets/svg/icons/Person.svg";
import Thunder from "/src/assets/svg/icons/Thunder.svg";
import { motion } from "framer-motion";
import FeatureCard from "../components/FeatureCard";
import PurpleGradient from "/src/assets/svg/Services_purple.svg";
import PinkGradient from "/src/assets/svg/Services_pink.svg";
...
const Services = forwardRef((props, ref) => {
  return (
    <section
      ref={ref}
      className="relative flex flex-col px-4 justify-center scroll-m-12 py-20"
    >
      <img
        src={PurpleGradient}
      ...
      <div className="w-full max-w-screen-2xl mx-auto">
        <div className="pt-2 pb-4">
          ...
          <p className="leading-tight text-gray-700 font-poppins text-xl md:text-[1.2rem] py-2 2xl:text-2xl transition">
            HR Flow offers variety of services for the ease of use of both HR
