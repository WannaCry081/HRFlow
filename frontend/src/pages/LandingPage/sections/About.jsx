    ...
    return (
        <div className="flex gap-3">
            ...
            <div className="w-full 2xl:w-4/5">
                <h1 className="font-lato font-extrabold text-jetblack text-xl md:text-2xl transition pb-2">
                    { props.title }
                </h1>
                <p className="text-md md:text-lg leading-normal font-poppins text-jetblack text-justify transition">
                    { props.body }
                </p>
            </div>
        </div>
